    ...
    <div className='flex justify-between items-center my-2 px-7'>
        <div className='flex gap-10'>
            <div  className=' cursor-pointer hover:scale-110 transition duration-300'>
              <AnchorLink href='#home'>Home</AnchorLink></div>
            <div className='cursor-pointer hover:scale-110 transition duration-300'>
              <AnchorLink href='#about'>About me</AnchorLink></div>
            <div className='cursor-pointer hover:scale-110 transition duration-300'>
              <AnchorLink href='#education'>Education</AnchorLink></div>
            <div className='cursor-pointer hover:scale-110 transition duration-300'>
              <AnchorLink href='#skills'>Skills</AnchorLink></div>
            <div className='cursor-pointer hover:scale-110 transition duration-300'>
              <AnchorLink href='#projects'>Projects</AnchorLink></div>
        </div>
        <div className='text-white cursor-pointer mr-5 font-semibold
